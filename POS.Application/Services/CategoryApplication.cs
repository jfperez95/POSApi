...
namespace POS.Application.Services
{
    public class CategoryApplication : ICategoryApplication
    {
        ...
        private readonly CategoryValidator _validatioRules;

        public CategoryApplication(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
            _validatioRules = new CategoryValidator();
        }
        ...
        public async Task<BaseResponse<bool>> EditCategory(int categoryId, CategoryRequestDto categoryDto)
        {
        ...
        public async Task<BaseResponse<bool>> RegisterCategory(CategoryRequestDto categoryDto)
        {
            var response = new BaseResponse<bool>();
            var validationResult = _validatioRules.Validate(categoryDto);
